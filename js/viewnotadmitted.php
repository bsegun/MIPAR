...
$sql = "select * from prospective where adm_status='Not Admitted' order by mode desc, gender desc";
...
<td></td>
	...
	<td></td>
<td><a href='#' onclick=\"smsallnad()\"><span class='glyphicon glyphicon-envelope'></span>Text All</a></td>
<td><a href='#' onclick=\"mailallnad()\"><span class='glyphicon glyphicon-inbox'></span>Mail All</a></td>
<td><a href='#' onclick=\"dallnad()\"><span class='glyphicon glyphicon-download'></span>Dowload All</a></td>
		</tr>
