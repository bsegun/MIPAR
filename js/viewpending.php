...
$sql = "select * from prospective where adm_status='Pending' order by mode desc, gender desc";
...
<td></td>
	...
	<td></td>
<td><a href='#' onclick=\"smsallpd()\"><span class='glyphicon glyphicon-envelope'></span>Text All</a></td>
<td><a href='#' onclick=\"mailallpd()\"><span class='glyphicon glyphicon-inbox'></span>Mail All</a></td>
<td><a href='#' onclick=\"dallpd()\"><span class='glyphicon glyphicon-download'></span>Dowload All</a></td>
		</tr>
